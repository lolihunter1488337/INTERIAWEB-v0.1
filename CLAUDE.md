...
## План: раздел «INTERIA BIBLE» в панели (идея, ещё не сделано)
- Источник: C:\Users\1\Desktop\INTERIA RECORDS\INTERIA BIBLE FULL\INTERIA_BIBLE — 35 .md в 9 папках.
- Рекомендованный вариант: проводник (дерево слева) + читалка markdown (справа), read-only. Контент бандлить в репо
  (src/bible/ + import.meta.glob raw), рендер через marked. Редактирование — через файлы/git, панель показывает актуальное.
