...
## Языки RU/EN (СЛЕДУЮЩАЯ ЗАДАЧА — в памяти)
- Сделать переключатель: по умолчанию РУССКИЙ + 3–4 самых популярных на выбор (EN + ещё 2–3, напр. ES/DE/FR/PT — уточнить).
- Дальше подумаем над охватом. Пока просто заложить структуру перевода.
