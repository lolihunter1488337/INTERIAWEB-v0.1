...
- FIX (план, лайт-авторизация): пароль → env PANEL_PASSWORD; /api/panel и /api/ya требуют заголовок x-panel-key
  (проверка на сервере); панель шлёт его из sessionStorage после ввода. Убрать PASS из кода.
